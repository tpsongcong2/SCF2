...
@media print{
  ...
  body{padding:0}
  .print-sheet{width:100%;min-height:210mm;padding:15mm}
}
  ...
  if (template === 'foseca') {
    ...
    <style>
      ...
      *{box-sizing:border-box}
      @media print{body{margin:0}.print-sheet{width:100%;min-height:297mm;padding:15mm}@page{size:210mm 297mm;margin:0}}
    <\/style><\/head><body><div class="print-sheet">
...
<style>
  *{box-sizing:border-box}
  ...
  @media print{body{padding:0}.print-sheet{width:100%;min-height:210mm;padding:15mm}@page{size:297mm 210mm;margin:0}}
<\/style><\/head><body><div class="print-sheet">
