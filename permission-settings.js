...
const SCF_PERMISSION_SECTIONS=[
  ...
  {sec:'Bán hàng',pages:[['quotes','Báo giá'],['delivery','Đơn giao hàng'],['intem','In tem'],['orderdetail','Chi tiết đơn hàng'],['trips','Chuyến giao hàng'],['marketsales','Báo cáo công nợ'],['invoicereport','Báo cáo hóa đơn'],['powdersales','Bán bột bún'],['prodshifts','Cài đặt ca SX + ca GH tự động'],['deliverysequence','Cài đặt thứ tự giao']]},
...
const DEFAULT_PERMISSION_PROFILES={
  ...
  director:scfProfile('director','Ban giám đốc','manager','Ban Giám Đốc',['company','appearance','printtemplates','employees','attendance','attendance_report','advances','rewards','employee_errors','employee_uniforms','leaves','tasks','workreport_vp','workreport_sx','workreport_lx','workreport_total','process_accounting','process_bun','process_pho','process_banhcuon','materials','assets','garages','depts','products','customers','areas','prodshifts','deliveryrules','workcats','shifts','quotes','delivery','intem','orderdetail','trips','marketsales','invoicereport','powdersales','nccgoods','purchasegoods','fuelpurchases','maint_vehicle','maint_machine','prodsummary','prodorders','stock','notifications','userguide'],['company','appearance','printtemplates','attendance_report','workreport_vp','workreport_sx','workreport_lx','workreport_total','materials','products','customers','orderdetail']),
  accounting_manager:scfProfile('accounting_manager','Quản lý kế toán','manager','Kế toán',[...SCF_PROFILE_COMMON,'advances','rewards','employee_errors','employee_uniforms','workreport_vp','workreport_total','process_accounting','materials','assets','products','customers','areas','deliveryrules','quotes','delivery','intem','orderdetail','trips','nccgoods','purchasegoods','fuelpurchases','marketsales','invoicereport','powdersales','deliverysequence'],['attendance_report','workreport_total','materials','assets','products','customers','areas','orderdetail']),
  accounting_staff:scfProfile('accounting_staff','Nhân viên kế toán','staff','Kế toán',[...SCF_PROFILE_COMMON,'advances','rewards','workreport_vp','workreport_total','process_accounting','materials','products','customers','areas','deliveryrules','quotes','delivery','intem','orderdetail','trips','nccgoods','purchasegoods','invoicereport','deliverysequence'],['attendance_report','workreport_total','materials','products','customers','areas','orderdetail']),
