...
const SCF_PERMISSION_SECTIONS=[
  ...
  {sec:'Bán hàng',pages:[['quotes','Báo giá'],['delivery','Đơn giao hàng'],['intem','In tem'],['orderdetail','Chi tiết đơn hàng'],['trips','Chuyến giao hàng'],['marketsales','Báo cáo công nợ'],['invoicereport','Báo cáo hóa đơn'],['powdersales','Bán bột bún']]},
...
const DEFAULT_PERMISSION_PROFILES={
  ...
  accounting_manager:scfProfile('accounting_manager','Quản lý kế toán','manager','Kế toán',[...SCF_PROFILE_COMMON,'advances','rewards','employee_errors','employee_uniforms','workreport_vp','workreport_total','process_accounting','materials','assets','products','customers','areas','deliveryrules','quotes','delivery','intem','orderdetail','trips','nccgoods','purchasegoods','fuelpurchases','marketsales','invoicereport','powdersales'],['attendance_report','workreport_total','materials','assets','products','customers','areas','orderdetail']),
  accounting_staff:scfProfile('accounting_staff','Nhân viên kế toán','staff','Kế toán',[...SCF_PROFILE_COMMON,'advances','rewards','workreport_vp','workreport_total','process_accounting','materials','products','customers','areas','deliveryrules','quotes','delivery','intem','orderdetail','trips','nccgoods','purchasegoods','invoicereport'],['attendance_report','workreport_total','materials','products','customers','areas','orderdetail']),
